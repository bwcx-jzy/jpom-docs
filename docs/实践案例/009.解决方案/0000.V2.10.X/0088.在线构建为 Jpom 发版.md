...
#
RUN curl -LfSo ${JPOM_HOME}/${JPOM_PKG} https://d2.jpom.download/release/${JPOM_PKG_VERSION}/${JPOM_PKG}
RUN curl -LfsSo ${JPOM_HOME}/${SHA1_NAME} https://d2.jpom.download/release/${JPOM_PKG_VERSION}/${SHA1_NAME} && \
